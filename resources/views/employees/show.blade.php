    ...
    <div class="w-full flex justify-center">
        ...
        <div class=" p-4 w-full  h-full md:h-auto">
            <div class=" w-full p-4 ">
                ...
                <dl class="border rounded-box p-4 mb-4">
                    ...
                    <dt class="font-semibold leading-none text-gray-900 dark:text-white"> Department Name : </dt>
                    ...
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Image:</dt>
                    <dd class="mb-4">
                        @if ($employee->image)
